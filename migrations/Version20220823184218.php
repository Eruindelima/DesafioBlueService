 ...
 */
final class Version20220823184218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produtos (id INT NOT NULL, caracteristica_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, descricao VARCHAR(255) NOT NULL, imagem VARCHAR(255) NOT NULL, preco DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
